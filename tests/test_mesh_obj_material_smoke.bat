...
set OUT_FILE=%SCRIPT_DIR%outputs\mesh_obj_material_smoke.exr
...
"%OIIOTOOL_BIN%" "%OUT_FILE%" --printstats | findstr /C:"Stats Avg: 0.000000 1.000000 0.000000 1.000000" >nul
if errorlevel 1 exit /b 1
