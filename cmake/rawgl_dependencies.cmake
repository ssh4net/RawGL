...
foreach(rawgl_oiio_target OpenImageIO::OpenImageIO OpenImageIO::OpenImageIO_Util)
    if(TARGET ${rawgl_oiio_target})
        if(TARGET BZip2::BZip2)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} BZip2::BZip2)
        endif()
        if(TARGET pugixml::pugixml)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} pugixml::pugixml)
        elseif(TARGET pugixml)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} pugixml)
        endif()
        if(TARGET libuhdr::libuhdr)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} libuhdr::libuhdr)
        endif()
        if(TARGET Freetype::Freetype)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} Freetype::Freetype)
        endif()
        if(TARGET sharpyuv::sharpyuv)
            rawgl_append_unique_interface_link_libraries(${rawgl_oiio_target} sharpyuv::sharpyuv)
        endif()
    endif()
endforeach()
