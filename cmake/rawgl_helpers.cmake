...
function(rawgl_configure_python_from_prefix_path)
    ...
    foreach(_rawgl_python_root_hint IN ITEMS "${Python_ROOT_DIR}")
    ...
    foreach(_rawgl_python_existing_executable IN ITEMS "${Python_EXECUTABLE}")
...
print(sysconfig.get_config_var("EXT_SUFFIX") or "")
    ...
    if(WIN32 AND NOT Python_LIBRARY AND NOT Python_LIBRARY_RELEASE AND NOT Python_LIBRARY_DEBUG)
        return()
    endif()
    ...
    if(_rawgl_python_interpreter_id)
    ...
    if(DEFINED _rawgl_python_extension_suffix)
