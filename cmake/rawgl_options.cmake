...
option(RAWGL_TESTS "Build RawGL test targets." OFF)
option(RAWGL_BUILD_PYTHON "Build Python bindings with nanobind." ON)
option(RAWGL_BUILD_WHEEL "Add a `rawgl_wheel` target (Python wheel build)." ON)
...
# Drop the removed Python scaffold/core switch from existing build trees.
unset(RAWGL_PYTHON_BIND_CORE CACHE)
unset(RAWGL_PYTHON_BIND_CORE)
if(WIN32)
...
if(DEFINED BUILD_TESTING)
    get_property(_rawgl_tests_cache_defined CACHE RAWGL_TESTS PROPERTY TYPE SET)
    if(NOT _rawgl_tests_cache_defined)
        set(RAWGL_TESTS "${BUILD_TESTING}" CACHE BOOL "Build RawGL test targets." FORCE)
    endif()
...
if(RAWGL_DOCS_ONLY)
    ...
    set(RAWGL_TESTS OFF CACHE BOOL "Build RawGL test targets." FORCE)
endif()
